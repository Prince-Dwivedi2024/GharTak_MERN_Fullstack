...
const TopWorkers = () => {
  ...
  // Simulate or detect loading state
  useEffect(() => {
    ...
    <div className="flex flex-col items-center gap-4 my-16 text-gray-900 md:mx-10">
      ...
      {loading ? (
        <div className="flex justify-center items-center w-full h-60">
          <div className="loader border-4 border-orange-200 border-t-orange-500 rounded-full w-10 h-10 animate-spin"></div>
        </div>
      ) : (
      ...
      <button
        ...
        className="bg-orange-50 text-gray-600 px-12 py-3 rounded-full mt-10"
      >
        more
      </button>
    </div>
