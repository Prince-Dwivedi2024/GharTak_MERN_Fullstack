     ...
     <div>
      ...
      <p className='font-medium'>Birthday :</p>
      {
        ...
        : <p className='text-gray-400'>{userData.dob}</p>
          ...
          <div className='mt-10'>
            {
              isEdit ? <button className='border border-primary px-8 py-2 rounded-full bg-gray-50 hover:bg-primary hover:text-white transition-all' onClick={updateUserProfileData}>Save information</button>
