...
//state of userData
  const [userData, setUserData] = useState({
    ...
    address:{
      ...
      line2:"Dalmia street Rourkela",
    },
    gender:"Male",
    dob:"2000-01-200",
  })
 //state of edit condition
     ...
     <div>
      ...
      <p className='font-medium'>Birthday :</p>
      {
        ...
        : <p className='text-gray-400'>{userData.dob}</p>
          ...
          <div className='mt-10'>
            {
              isEdit ? <button className='border border-primary px-8 py-2 rounded-full bg-gray-50 hover:bg-primary hover:text-white transition-all' onClick={()=> setIsEdit(false)}>Save information</button>
              : <button className='border border-primary px-8 py-2 rounded-full bg-gray-50 hover:bg-primary hover:text-white transition-all' onClick={() => setIsEdit(true)}>Edit</button>
            }
          </div>
    </div>
  )
